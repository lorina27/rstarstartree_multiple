...
public final class BenchmarksRTree_rStarTreeSearchOfGreekDataPointsMaxChildren004_jmhTest {
    ...
    public BenchmarkTaskResult rStarTreeSearchOfGreekDataPointsMaxChildren004_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_benchmarksrtree0_G.rStarTreeSearchOfGreekDataPointsMaxChildren004());
                res.allOps++;
            }
    ...
    public BenchmarkTaskResult rStarTreeSearchOfGreekDataPointsMaxChildren004_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "rStarTreeSearchOfGreekDataPointsMaxChildren004", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");

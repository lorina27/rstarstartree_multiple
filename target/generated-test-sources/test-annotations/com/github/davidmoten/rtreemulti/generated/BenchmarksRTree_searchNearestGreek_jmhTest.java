package com.github.davidmoten.rtreemulti.generated;
...
import com.github.davidmoten.rtreemulti.generated.BenchmarksRTree_jmhType;
public final class BenchmarksRTree_searchNearestGreek_jmhTest {
    ...
    public BenchmarkTaskResult searchNearestGreek_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_benchmarksrtree0_G.searchNearestGreek());
                res.allOps++;
            }
    ...
    public static void searchNearestGreek_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, BenchmarksRTree_jmhType l_benchmarksrtree0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult searchNearestGreek_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "searchNearestGreek", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    BenchmarksRTree_jmhType _jmh_tryInit_f_benchmarksrtree0_G(InfraControl control) throws Throwable {

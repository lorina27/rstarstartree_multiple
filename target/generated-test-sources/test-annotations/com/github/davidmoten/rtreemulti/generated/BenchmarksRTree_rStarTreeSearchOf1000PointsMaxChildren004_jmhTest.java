...
public final class BenchmarksRTree_rStarTreeSearchOf1000PointsMaxChildren004_jmhTest {
    ...
    public BenchmarkTaskResult rStarTreeSearchOf1000PointsMaxChildren004_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_benchmarksrtree0_G.rStarTreeSearchOf1000PointsMaxChildren004();
                res.allOps++;
            }
    ...
    public BenchmarkTaskResult rStarTreeSearchOf1000PointsMaxChildren004_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "rStarTreeSearchOf1000PointsMaxChildren004", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");

...
public final class BenchmarksRTree_rStarTreeSearchOfGreekDataPointsMaxChildren010_jmhTest {
    ...
    public BenchmarkTaskResult rStarTreeSearchOfGreekDataPointsMaxChildren010_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_benchmarksrtree0_G.rStarTreeSearchOfGreekDataPointsMaxChildren010());
                res.allOps++;
            }
    ...
    public BenchmarkTaskResult rStarTreeSearchOfGreekDataPointsMaxChildren010_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "rStarTreeSearchOfGreekDataPointsMaxChildren010", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
